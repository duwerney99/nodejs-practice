...
const {
    ...
    validateUserId,
    validateUserUpdate
} = require("../uitls/middleware/ValidateUsers");
...
router.post("/",validateUserRegister,usersController.RegisterUser);
...
router.get("/:usuarioId",Auth,usersController.GetUser);
...
router.put("/:usuarioId",Auth,usersController.UpdateUser);
...
router.delete("/:usuarioId",Auth,usersController.DeleteUser);
